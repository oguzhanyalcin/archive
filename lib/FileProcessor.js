...
var ghostscriptCompressPdf= "gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dPDFSETTINGS=/screen -dNOPAUSE -dQUIET -dBATCH -sOutputFile=";
//================================================================================================//
...
module.exports = function (settings) {
    return {
        ...
        compressPdf: function (callback, originalFile, targetFile) {
            ...
            exec(ghostscriptCompressPdf+  targetFile +" "+ originalFile , function (error) {
                winston.profile("compress");
                callback(error);
            });
        },
